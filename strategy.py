...
def step_0(player, table):
    if gameSettings.DEBUG_print_agent_steps: print("Check step 0")
    decision = 0
...
def step_1(player, table):
    if gameSettings.DEBUG_print_agent_steps: print("Check step 1")
    decision = 1
    target_player = player
    result = 0
...
def step_2(player, table):
    if gameSettings.DEBUG_print_agent_steps: print("Check step 2")
    decision = 2
...
def step_3(player, table):
    if gameSettings.DEBUG_print_agent_steps: print("Check step 3")
    decision = 3
    target_player = table.player_list[(table.total_turn_counter + 1) % gameSettings.player_amount]
    result = ''
    if table.tokens.note_tokens > 0:
...
def step_4(player, table):
    if gameSettings.DEBUG_print_agent_steps: print("Check step 4")
    decision = 4
...
def step_5(player, table):
    if gameSettings.DEBUG_print_agent_steps: print("Check step 5")
    decision = 5
    found_target = False
    if table.tokens.note_tokens > 0:
...
def step_6(player, table):
    if gameSettings.DEBUG_print_agent_steps: print("Check step 6")
    decision = 6
    target_player = player
    result = 0
    found_card = False
...
def step_7(player, table):
    if gameSettings.DEBUG_print_agent_steps: print("Check step 7")
    decision = 7
    target_player = player
    result = 0
    target_found = False
...
def step_8(player, table):
    if gameSettings.DEBUG_print_agent_steps: print("Check step 8")
    decision = 8
    target_player = player
    if table.tokens.note_tokens > 0:
        decision = 80
